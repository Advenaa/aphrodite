...
That is evidence only. It usually means disk verification is newer than the currently running service. It does **not** prove the service is broken, and it does **not** authorize any Hermes profile or agent runtime to start, restart, reload, enable, disable, or reconfigure anything.
...
- Do not edit Hermes config or restart/reload/replace Hermes, any Hermes profile, Aphrodite, or any gateway.
